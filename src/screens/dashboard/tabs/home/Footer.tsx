...
const Footer = ({ footer, index, accentColors , isHorizontal, isFromMenu}) => {
  ...
  if (isMarquee) {
    ...
    return <AutoHeightWebView isHorizontal={isHorizontal} isFromMenu={isFromMenu} isFromPage={false} html={footer} />;
  } else {
    return (
      <Text
        style={{
